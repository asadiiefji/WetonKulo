...
class Weton: ObservableObject {
    ...
    let fiveCycles: [DatabaseFiveCycle] = [
        DatabaseFiveCycle(result: "Lungguh", interpretation: "Ibarat mahkota yang memperindah kepala, kamu dan pasanganmu dipercaya akan mempunyai jabatan yang bagus dan menghasilkan keturunan yang dapat mengangkat derajat kedua orang tuanya.", tips: "Kamu dan pasanganmu akan mempunyai jabatan yang bagus jika menikah.", image: "senang"),
        DatabaseFiveCycle(result: "Sri", interpretation: "Ibarat tanah yang subur, kamu dan pasanganmu dipercaya akan membangun rumah tangga yang sehat, keturunan yang baik serta banyak rejeki.", tips: "Kamu dan pasanganmu akan dikaruniai anak yang baik jika menikah.", image: "senang"),
        DatabaseFiveCycle(result: "Dunya", interpretation: "Ibarat lautan dengan sumber dayanya, kamu dan pasanganmu dipercaya akan menghasilkan banyak rejeki dan menjadi kaya.", tips: "Kamu dan pasanganmu akan hidup dengan banyak rejeki jika menikah.", image: "senang"),
        DatabaseFiveCycle(result: "Lara", interpretation: "Ibarat bangunan yang retak, kamu dan pasanganmu dipercaya akan hidup kesusahan dan salah satunya akan sakit-sakitan.", tips: "Kamu dan pasanganmu dapat menentukan hari baik untuk menikah.", image: "sedih"),
        DatabaseFiveCycle(result: "Pati", interpretation: "Ibarat perahu yang berlayar tanpa bahan bakar, kamu atau pasanganmu dipercaya akan hidup sengsara karena ditinggal mati salah satu calon atau orang tua calon.", tips: "Kamu dan pasanganmu dapat menentukan hari baik untuk menikah.", image: "sedih")
    ]
    
    let sevenCycles: [DatabaseSevenCycle] = [
        DatabaseSevenCycle(result: "Lebu Katiup Angin", interpretation: "Layaknya perahu di tengah badai, kamu dan pasanganmu dipercaya akan sering mendapat kesusahan, semua cita-citanya sulit terkabul dan kehidupan yang tidak menentu.", tips: "Kamu dan pasanganmu harus menebar tanah kelahiran di sekitar rumah untuk menghindari masalah yang akan terjadi jika menikah.", image: "mikir"),
        DatabaseSevenCycle(result: "Wasesa Segara", interpretation: "Layaknya pelita yang menerangi kegelapan, kamu dan pasanganmu dipercaya sebagai sosok yang low profile, baik perwatakannya, pemaaf dan mempunyai wibawa. Selain itu memiliki pandangan hidup yang luas dalam perhikahan dan akan rukun selalu.", tips: "Kamu dan pasanganmu akan hidup berwibawa jika menikah.", image: "senang"),
        DatabaseSevenCycle(result: "Tunggak Semi", interpretation: "Layaknya sumur yang berlimpah air, kamu dan pasanganmu dipercaya akan mudah mencari rejeki, seperti memiliki banyak anak. Namun, kamu dan pasanganmu akan mudah jatuh sakit.", tips: "Kamu dan pasanganmu akan mudah jatuh sakit jika menikah.", image: "senang"),
        DatabaseSevenCycle(result: "Satriya Wibawa", interpretation: "Layaknya pohon yang berbuah banyak, kamu dan pasanganmu dipercaya akan hidup berlimpah serta mendapat anugrah dan kemuliaan.", tips: "Kamu dan pasanganmu akan hidup berlimpah rezeki jika menikah.", image: "senang"),
        DatabaseSevenCycle(result: "Sumur Sinaba", interpretation: "Layaknya mercusuar yang memberi petunjuk, kamu dan pasanganmu dipercaya akan menjadi penolong orang lain, tempat untuk mendapatkan ilmu dan sering dicontoh.", tips: "Kamu dan pasanganmu akan menjadi contoh jika menikah.", image: "senang"),
        DatabaseSevenCycle(result: "Satriya Wirang", interpretation: "Layaknya musim kemarau yang panjang, kamu dan pasanganmu dipercaya akan mengalami kesusahan dan kekurangan secara finansial.", tips: "Kamu dan pasanganmu harus menyembelih hewan agar dapat menghindari masalah yang akan terjadi jika menikah.", image: "sedih"),
        DatabaseSevenCycle(result: "Bumi Kapetak", interpretation: "Layaknya pulau yang terpencil, kamu dan pasanganmu dipercaya akan menjadi pasangan yang tertutup/tersisih dari pergaulan tetapi menghadapi kehidupan yang berkecukupan dan kuat menghadapi kesulitan.", tips: "Kamu dan pasanganmu harus menanam tanah agar dapat menghindari masalah yang akan terjadi jika menikah.", image: "mikir")
    ]
    
    let eightCycles: [DatabaseEightCycle] = [
        DatabaseEightCycle(result: "Pesthi", interpretation: "Bagai malam tenang yang penuh dengan bintang-bintang, kamu dan pasanganmu dipercaya akan mendapat kehidupan yang selalu aman, damai, tentram dan rukun sampai tua. Walaupun nantinya dihadapkan dengan masalah tapi tidak akan merusak keharmonisan dalam rumah tangga.", tips: "Kamu dan pasanganmu akan hidup damai, tentram dan aman jika menikah.", image: "mikir"),
        DatabaseEightCycle(result: "Pegat", interpretation: "Bagaikan jalan buntu, kamu dan pasanganmu nanti dipercaya akan menghadapi suatu masalah yang berujung pada perceraian yang disebabkan oleh faktor ekonomi maupun perselingkuhan.", tips: "Kamu dan pasanganmu harus memperbanyak ikhtiar dan doa.", image: "sedih"),
        DatabaseEightCycle(result: "Ratu", interpretation: "Bagai seorang ratu yang dihargai, kamu dan pasanganmu dipercaya akan hidup seperti seorang ratu/diratukan dengan harta, hidup harmonis, disegani dan dihargai oleh masyarakat.", tips: "Kamu dan pasanganmu akan diratukan jika menikah.", image: "senang"),
        DatabaseEightCycle(result: "Jodoh", interpretation: "Bagai dua puzzle yang cocok, kamu dan pasanganmu dipercaya akan dapat membangun rumah tangga yang harmonis hingga akhir hayat karena ditakdirkan berjodoh dan menerima kelebihan maupun kekurangan pasangan.", tips: "Kamu dan pasanganmu akan hidup harmonis jika menikah.", image: "senang"),
        DatabaseEightCycle(result: "Topo", interpretation: "Bagaikan berlayar di lautan yang gelap, kamu dan pasanganmu dipercaya akan mendapat banyak masalah di kehidupan awal rumah tanggamu, seperti permasalahan ekonomi. Namun jika kamu dan pasanganmu dapat bertahan dan melalui masalah itu, maka seiring dengan berjalannya waktu rumah tanggamu akan baik-baik saja dan harmonis.", tips: "Kamu dan pasanganmu harus tau menyikapi setiap masalah yang mungkin muncul dalam rumah tangga.", image: "mikir"),
        DatabaseEightCycle(result: "Tinari", interpretation: "Bagai bunga yang tumbuh subur, kamu dan pasanganmu dipercaya akan hidup bahagia dan kondisi keuangan rumah tangga kalian akan berkecukupan dan hidup yang kalian dijalani akan selalu diselimuti dengan keberuntungan.", tips: "Kamu dan pasanganmu akan diselimuti keberuntungan jika menikah.", image: "senang"),
        DatabaseEightCycle(result: "Padu", interpretation: "Bagaikan perang tanpa henti, kamu dan pasanganmu dipercaya akan sering mengalami masalah pertengkaran dalam kehidupan rumah tanggamu karena masalah sepele dan terdapat kemungkinan untuk berpisah.", tips: "Kamu dan pasanganmu perlu menetapkan hari baik untuk menikah.", image: "sedih"),
        DatabaseEightCycle(result: "Sujanan", interpretation: "Bagai sebuah gelombang yang menghantam pantai, kamu dan pasanganmu nanti dipercaya akan menghadapi kehidupan yang akan diselimuti dengan perselingkuhan maupun suatu pertengkaran yang disebabkan karena pihak laki-laki maupun pihak perempuan yang berselingkuh.", tips: "Kamu dan pasanganmu tidak boleh melanjutkan ke jenjang pernikahan karena dipercaya rumah tanggamu akan berakhir.", image: "sedih")
    ]
